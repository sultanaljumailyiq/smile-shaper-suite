            ...
            {activeCategory === "directory" && (
              <div id="directory-map" className="mb-8">
                ...
                <div className="flex flex-wrap justify-center md:gap-4 gap-0.5 mb-5">
                  ...
                  <div
                    onClick={() => handleCardClick("#directory-map")}
                ...
                <div className="bg-white rounded-xl border shadow p-6">
                  ...
                  <InteractiveJobsMap
                    mode="clinics"
                    jobs={clinicJobs as any}
                    selectedJob={selectedClinicJob}
                    onJobSelect={(job: any) => setSelectedClinicJob(job)}
                    onShowJobDetails={() => {}}
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-2 -mx-2 px-2">
                      {clinicJobs.map((job) => (
                        <div
                          key={job.id}
                          className={cn(
                            "min-w-[280px] bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all",
                            selectedClinicJob?.id === job.id &&
                              "ring-2 ring-teal-500",
                          )}
                        >
                          <div
                            className="p-3 cursor-pointer"
                            onClick={() => setSelectedClinicJob(job)}
                          >
              ...
              <div id="clinic-map" className="mb-8">
                <div className="bg-white rounded-xl border shadow p-6">
                  ...
                  <CompactInteractiveMap
                    title="خريطة العيادات القريبة"
                    description="اعثر على أقرب عيادات الأسنان واحجز موعدك بسهولة"
