        ...
        <div className="px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              <button
                onClick={() => navigate("/dentist-hub/smart-clinic/overview")}
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  إدارة المحتوى والمصادر التعليمية
                </p>
              </div>
            </div>
                    ...
                    {contentTypes.map(type => (
                      <option key={type} value={type}>
                        {type === "all" ? "جميع الأنواع" : 
                         ...
                         type === "video" ? "فيديوهات" :
                         type === "image" ? "صور" :
                         type === "document" ? "مستندات" : "روابط خارجية"}
                      </option>
                    ))}
                  </select>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between text-xs text-gray-500">
                        ...
                        <Badge 
                          variant="outline" 
                          className={cn(
                            item.status === "published" ? "text-green-600 border-green-200" :
                            item.status === "draft" ? "text-yellow-600 border-yellow-200" :
                      ...
                      <div className="flex items-center gap-3">
                        <Badge className={getStatusColor(source.status)}>
                          {source.status === "active" ? "نشط" :
                           source.status === "inactive" ? "غير نشط" : "خطأ"}
                        </Badge>
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="وصف أو محتوى المادة..."
                rows={4}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setNewContent({...newContent, tags: e.target.value.split(", ").filter(t => t.trim())})}
                placeholder="كلمة1, كلمة2, كلمة3..."
              />
            </div>
            
            {(newContent.type === "video" || newContent.type === "external") && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  الرابط
                </label>
