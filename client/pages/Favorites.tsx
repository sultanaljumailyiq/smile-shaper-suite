...
const favoriteCommunityItems = [
  {
    ...
    excerpt:
      "اكتشف أحدث الت��نيات التي تجعل إجراءات قناة الجذر خالية من الألم تقر��باً وتقلل وقت التعافي بنسبة 50%.",
    author: {
      name: "د. سارة أحمد",
      avatar:
  ...
  },
  {
    ...
    content:
      "أعمل كطبيب أسنان أطفال م��ذ 5 سنوات وما زلت أواجه تح��يات مع الأطفال القلقين. هل لديكم تقنيات مجربة للتعامل مع هذه الحالات�� 🦷👶",
    author: {
      name: "د. أحمد محمد",
      avatar:
  ...
  },
  {
    ...
    excerpt:
      "مريض 45 عاماً فقد 6 أسنان أمامية في حادث. شاهد كيف استطعنا استعادة ابتسامته باستخدام تقنيات مت��دمة.",
    author: {
      name: "د. فاطمة حسن",
      avatar:
  ...
  useEffect(() => {
    ...
    const loadClinics = async () => {
      try {
        ...
        if (mounted)
          setClinicsCount(Array.isArray(clinics) ? clinics.length : 0);
      } catch {
    ...
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300">
      <div className="p-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            to={`/jobs/${item.id}`}
            className="bg-violet-600 text-white px-3 py-1.5 rounded-lg hover:bg-violet-700 transition-colors text-xs font-medium"
          >
            عرض التفاصيل
          </Link>
        </div>
    ...
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300">
      ...
      <div className="p-3">
        ...
        <Link
          ...
          className="w-full bg-rose-600 text-white py-1.5 px-3 rounded-lg hover:bg-rose-700 transition-colors text-center text-xs font-medium block"
        >
  ...
  return (
    <div className="min-h-screen bg-gray-50 with-floating-nav relative">
      <ModernUnifiedHeader
        ...
        searchPlaceholder="ابح���� في المفضلة والمحفوظات..."
      />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-4">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-3">
                <p className="text-xs text-gray-500 mb-1">الوظائف</p>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-3">
                <p className="text-xs text-gray-500 mb-1">محفوظاتي</p>
