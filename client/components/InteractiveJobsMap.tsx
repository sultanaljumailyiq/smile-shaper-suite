...
export default function InteractiveJobsMap({
  ...
  const JobDetailsPanel = () => {
    const isVisible =
      typeof onShowJobDetails === "function"
        ? (selectedJob && (localShowJobDetails || false)) || false
        : selectedJob && localShowJobDetails;
    ...
    const requirements = Array.isArray(selectedJob.requirements)
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          <div className="bg-blue-50 rounded-xl p-4 text-center">
            ...
            <div className="text-sm text-blue-700">
              {mode === "clinics" ? "عيادات مميزة" : "وظائف مميزة"}
            </div>
          </div>
          ...
          <div className="bg-red-50 rounded-xl p-4 text-center">
            ...
            <div className="text-sm text-red-700">
              {mode === "clinics" ? "متاحة فوراً" : "وظائف عاجلة"}
            </div>
          </div>
          ...
          <div className="bg-green-50 rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-green-600 mb-1">
              {mode === "clinics"
                ? geoJobs.filter((job) => (job.company_rating || 0) >= 4.5)
                    .length
                : geoJobs.filter((job) => job.remote).length}
            </div>
            <div className="text-sm text-green-700">
              {mode === "clinics" ? "بتقييم 4.5+" : "عمل عن بُعد"}
            </div>
          </div>
